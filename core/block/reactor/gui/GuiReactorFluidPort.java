...
extends GuiContainer {
    public ContainerReactorFluidPort container;
    String name;
    ...
    public GuiReactorFluidPort(ContainerReactorFluidPort container1) {
        super((Container)container1);
        this.container = container1;
        this.name = StatCollector.translateToLocal((String)"ic2.ReactorFluidPort.gui.name");
    }
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        GuiTooltipHelper.drawAreaTooltip(par1 - this.guiLeft, par2 - this.guiTop, StatCollector.translateToLocal((String)"ic2.ReactorFluidPort.gui.info"), 80, 43, 95, 58);
    }
