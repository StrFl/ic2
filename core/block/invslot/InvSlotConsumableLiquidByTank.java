...
extends InvSlotConsumableLiquid {
    ...
    public InvSlotConsumableLiquidByTank(TileEntityInventory base1, String name1, int oldStartIndex1, InvSlot.Access access1, int count, InvSlot.InvSide preferredSide1, InvSlotConsumableLiquid.OpType opType, IFluidTank tank1) {
